...
//     </div>`;
//         messages.insertAdjacentHTML('beforeend', robotMsg);//добавляем после message html код, Element.insertAdjacentText()вставит только текст так же как Node.textContent 
//         chat.value = '';
...
const widget = document.querySelector('.chat-widget');
const chat = document.querySelector('.chat-widget__input');
...
document.addEventListener('click', clickWidget);
